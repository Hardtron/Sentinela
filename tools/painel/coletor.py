...
PLACAS = [
    {"id": "HTC-01", "node_id": 1, "mac": "3c:71:bf:8c:33:a8",
     "papel": "PINGER — placa substituta, enlace confirmado",
     "env": "node_dev", "flash": "4 MB", "antena": True},
    {"id": "HTC-02", "node_id": 2, "mac": "3c:71:bf:8c:2f:9c",
     "papel": "bancada — sem antena", "env": "bench_02", "flash": "4 MB",
     "antena": False},
    {"id": "HTC-03", "node_id": 3, "mac": "3c:71:bf:8c:2f:a4",
     "papel": "gateway/Farol — display defeituoso, irrelevante no telhado",
     "env": "bridge", "flash": "4 MB", "antena": True},
    {"id": "HTC-04", "node_id": 4, "mac": "3c:71:bf:8c:31:70",
     "papel": "nó de campo (display funcional) — aguarda antena",
     "env": "bench_04", "flash": "4 MB", "antena": False},
